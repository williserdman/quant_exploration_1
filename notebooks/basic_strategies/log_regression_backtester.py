...
if __name__ == "__main__":
    ...
    print(scibt.run_strategy("2010-1-1", "2016-12-31", "2017-1-1", "2019-12-31"))
    scibt = ScikitVectorBacktester(
        ".SPX", "2010-1-1", "2019-12-31", 10000, 0.001, "logistic"
    )
    print(
        scibt.run_strategy("2010-1-1", "2019-12-31", "2010-1-1", "2019-12-31", lags=15)
    )
    print(
        scibt.run_strategy("2010-1-1", "2013-12-31", "2014-1-1", "2019-12-31", lags=15)
    )
